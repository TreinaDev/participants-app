class Event
  attr_accessor :name, :event_type, :banner, :logo, :event_id, :event_owner, :local_event, :description, :url_event, :limit_participants, :start_date, :end_date, :batches, :schedules
  def initialize(event_id:, name:, event_type:, banner:, logo:, event_owner:, url_event:, local_event:, limit_participants:, description:, start_date:, end_date:, batches:, schedules:)
    @event_id = event_id
    @name = name
